...
function Card({
  ...
  return (
    <div
      className={cn(
        'group/card flex flex-col gap-4 overflow-hidden rounded-lg border bg-card py-4 text-card-foreground text-sm/relaxed has-[>img:first-child]:pt-0 data-[size=sm]:gap-3 data-[size=sm]:py-3 *:[img:first-child]:rounded-t-lg *:[img:last-child]:rounded-b-lg',
        className
      )}
      data-size={size}
      data-slot="card"
