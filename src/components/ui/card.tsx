...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        'border bg-card text-card-foreground gap-4 overflow-hidden rounded-lg py-4 text-sm/relaxed has-[>img:first-child]:pt-0 data-[size=sm]:gap-3 data-[size=sm]:py-3 *:[img:first-child]:rounded-t-lg *:[img:last-child]:rounded-b-lg group/card flex flex-col',
        className,
      )}
      {...props}
    />
